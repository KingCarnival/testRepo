...
cityDeathModel <- lm(deathsByAge$State ~ deathsByAge$All.Deaths + deathsByAge$City)
cityDeathModel2 <- lm(deathsByAge$State ~ deathsByAge$All.Deaths * deathsByAge$City)
